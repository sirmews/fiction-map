...
export const story = defineGraph(registry, {
  ...
  edges: [
    ...
    },
    {
      ...
      text: "Step through the hidden door into the Alchemist's Lab",
      conditions: [{ type: "notVisited", nodeId: "alchemists-lab" }],
      anchorBlockId: "archives-desc",
    },
    {
      id: "brew-elixir",
      ...
      target: "alchemists-lab",
      text: "Brew a Healing Elixir (-10 gold)",
      conditions: [
        { type: "notVisited", nodeId: "brew-elixir" },
        { type: "resourceAtLeast", key: "gold", value: 10 },
      ],
      effects: [
        { type: "spendResource", key: "gold", amount: 10, clampToZero: true },
        { type: "grantEntity", entityId: "elixir" },
    ...
    },
    {
      ...
      text: "Descend through the trapdoor into the flooded tunnel",
      anchorBlockId: "lab-hidden-passage",
    },
    {
      id: "swim-passage",
      type: "choice",
      ...
      target: "forgotten-crypt",
      text: "Swim through the freezing water (-30 HP)",
      effects: [{ type: "spendResource", key: "health", amount: 30, clampToZero: true }],
    ...
    },
    {
      ...
      source: "sunken-passage",
      target: "forgotten-crypt",
      text: "Cast Mage Light to illuminate the path and wade safely (-10 MP)",
      conditions: [
        { type: "hasEntity", entityId: "mage-light" },
        { type: "resourceAtLeast", key: "mana", value: 10 },
      ],
    ...
    },
    {
      ...
      source: "alchemists-lab",
      target: "archives",
      text: "Return to the Dusty Archives",
      anchorBlockId: "lab-desc",
    },
  ],
})
