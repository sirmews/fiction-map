...
| **Entity-Aware Runtime** | 🚧 In Progress | runtime entity state, derivation, built-in entity-aware primitives, failure details, and cross-validation exist; example coverage is next |
