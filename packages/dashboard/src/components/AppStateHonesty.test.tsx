...
describe("App state honesty", () => {
  test("surfaces unavailable metadata and refresh errors without substituting zero-state meaning", async () => {
    ...
    expect(screen.getByText("Metadata refresh failed on the server")).toBeTruthy()
    expect(
