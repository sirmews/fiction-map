...
export const builtinConditionConfigs: ConditionConfig[] = [
  { id: "equals", parameters: { key: { type: "string", required: true }, value: { type: "string", required: true } } },
  { id: "notEquals", parameters: { key: { type: "string", required: true }, value: { type: "string", required: true } } },
  { id: "greaterThan", parameters: { key: { type: "string", required: true }, value: { type: "number", required: true } } },
  { id: "greaterThanOrEqual", parameters: { key: { type: "string", required: true }, value: { type: "number", required: true } } },
  { id: "lessThan", parameters: { key: { type: "string", required: true }, value: { type: "number", required: true } } },
  { id: "lessThanOrEqual", parameters: { key: { type: "string", required: true }, value: { type: "number", required: true } } },
  { id: "hasFlag", parameters: { key: { type: "string", required: true } } },
  { id: "flagEquals", parameters: { key: { type: "string", required: true }, value: { type: "string", required: true } } },
...
export const builtinEffectConfigs: EffectConfig[] = [
  { id: "setVariable", parameters: { key: { type: "string", required: true }, value: { type: "string", required: true } } },
  { id: "deleteVariable", parameters: { key: { type: "string", required: true } } },
  { id: "increment", parameters: { key: { type: "string", required: true }, delta: { type: "number", required: true } } },
  { id: "decrement", parameters: { key: { type: "string", required: true }, delta: { type: "number", required: true } } },
  { id: "clamp", parameters: { key: { type: "string", required: true }, min: { type: "number", required: true }, max: { type: "number", required: true } } },
  { id: "setFlag", parameters: { key: { type: "string", required: true }, value: { type: "boolean", required: true } } },
  ...
  { id: "noOp", parameters: {} },
  { id: "setExtension", parameters: { key: { type: "string", required: true }, value: { type: "string" } } },
  { id: "mergeExtension", parameters: { key: { type: "string", required: true }, value: { type: "string" } } },
